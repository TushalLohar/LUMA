...
export const THEME_CONFIGS: Record<GameTheme, ThemeColors> = {
  spiderman: {
    name: "SPIDER-MAN",
    subtitle: "SWING THE SKYLINE. HOLD THE CITY.",
    bg: "#06030f",
    bgGradTop: "#1a0733",
    bgGradBottom: "#04010a",
    player: "#E62143",
    ...
    shield: "#2E6BFF",
    hud: "#FF9FB4",
    enemies: { basic: "#7C3AED", fast: "#22D3EE", tank: "#94A3B8", bomber: "#F472B6", kamikaze: "#E62143", boss: "#A855F7" },
    explosion: ["#E62143", "#2E6BFF", "#FFFFFF", "#A855F7", "#7FB2FF"],
  },
  ironman: {
    name: "IRON MAN",
    subtitle: "MARK 85. ARC REACTOR ONLINE.",
    bg: "#0b0206",
    bgGradTop: "#2a0710",
    bgGradBottom: "#050103",
    player: "#F5C24B",
    ...
    shield: "#3ED9FF",
    hud: "#F5C24B",
    enemies: { basic: "#8A98A8", fast: "#3ED9FF", tank: "#5B6675", bomber: "#FF7A18", kamikaze: "#C81E32", boss: "#E2E8F0" },
    explosion: ["#F5C24B", "#FF7A18", "#C81E32", "#FFFFFF", "#3ED9FF"],
  },
